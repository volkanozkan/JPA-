...
public class AllSubCategories extends HttpServlet
{
    ...
    {
        List list = subCategoryDAO.getAllSubcategories();
        request.setAttribute("list", list);
        request.getRequestDispatcher("allsubcategories.jsp").forward(request, response);
        logger.debug("SubCategories are listed..");
    }
